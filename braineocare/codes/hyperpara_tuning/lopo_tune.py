...
dataset_path = '/home/agasthi/braineocare/datasets/30min_post_30min_pre'
neon = 66

checkpoint_maindir = '/home/agasthi/braineocare/results_zenodo/LOPO/results/best_runs'
...
# 1) Save only PyTorch weights
torch.save(best_net.module_.state_dict(), f"/home/agasthi/braineocare/results_zenodo/LOPO/results/fine_tune/neon_{neon}/best_model_weights.pth")

# 2) Save full skorch object (includes preprocessing, hyperparams, etc.)
joblib.dump(best_net, f"/home/agasthi/braineocare/results_zenodo/LOPO/results/fine_tune/neon_{neon}/best_skorch_model.pkl")

best_net = joblib.load(f"/home/agasthi/braineocare/results_zenodo/LOPO/results/fine_tune/neon_{neon}/best_skorch_model.pkl")
